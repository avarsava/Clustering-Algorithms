 ...
 * @since 2016-04-18
 * 
 * Performs the K-Medians Clustering Algorithm on a provided data set.
 * Based on original K-Means code.
 */
...
public class Kmedians {
    ...
    public Kmedians(){
        ...
        output.renameTo(new File("outputs", Integer.toString(k) + ".txt"));
    }
    ...
    /**
     * Gets a cluster in the dictionary from a point
     * @param p location of cluster to find
     * @return cluster at location p
     */
